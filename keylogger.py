...
class keylog:
    def __init__(self, txtarea, txtbox):
...
if __name__ == "__main__":
    ...
    #ボタン
    button_run = tkinter.Button(body, text = "ログの削除", command = remove_log , font=("HGPｺﾞｼｯｸE", "13"))
    ...
    # バックグラウンド処理
    th1 = threading.Thread(target=keylog, args=(textarea, textbox1))
    th1.start()
